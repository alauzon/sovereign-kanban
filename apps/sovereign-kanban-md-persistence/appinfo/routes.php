...
return [
	'routes' => [
		...
		['name' => 'card#attachments', 'url' => '/api/v1/boards/{boardId}/cards/{cardId}/attachments', 'verb' => 'GET'],
		['name' => 'card#addAttachment', 'url' => '/api/v1/boards/{boardId}/cards/{cardId}/attachments', 'verb' => 'POST'],
		['name' => 'card#downloadAttachment', 'url' => '/api/v1/boards/{boardId}/cards/{cardId}/attachments/{name}', 'verb' => 'GET'],
		['name' => 'card#deleteAttachment', 'url' => '/api/v1/boards/{boardId}/cards/{cardId}/attachments/{name}', 'verb' => 'DELETE'],
